					...
					var output = '\
                        <div class="kt-user-card-v2">\
                            ...
                            <div class="kt-user-card-v2__details">\
                                <a href="' + APP_URL + 'projectManagers/' + data.id + '" class="kt-user-card-v2__name">' + data.name + '</a>\
                            </div>\
                        </div>';
				...
				template: function(data, i) {
					...
					var output = '';
						output = '<div class="kt-user-card-v2">\
									<div class="kt-user-card-v2__details">\
										<span class="kt-user-card-v2__name">' + data.email + '</span>\
					...
					template: function(data, i) {
						return '\
						<a href="' + APP_URL + 'projectManagers/' + data.id + '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Show details">\
						...
						<form action="' + APP_URL + 'projectManagers/'+data.id +'" class="d-inline-block" method="POST">\
...
var KTWizard2 = function() {
    ...
    return {
        init: function() {
            ...
            (i = e.find('[data-ktwizard-type="action-submit"]')).on("click", function(t) {
				e.attr('action', '/projectManagers/' + e.find('#eid').val());            	
                t.preventDefault(),
                o.form() && (KTApp.progress(i),
                e.ajaxSubmit({
                    success: function() {
