...
$conn = mysqli_connect('localhost','root','','ateamthe_ateam');
                                $queryapp = "SELECT * FROM paygroups ORDER by id ASC";
                                $query_app = mysqli_query($conn,$queryapp);
                                while($paygroup = mysqli_fetch_array($query_app)) {
                                ?>
                                <option value="<?php echo $paygroup['name'];?>"><?php echo $paygroup['name'];?></option>
                                <?php } ?>
                                </select>
            ...
            <div class="modal-content">
                ...
                <form class="kt-form" id="frmEdit" method="POST">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="form-control-label">Designation:</label>
                                <select name="desig" id="edesig" class="form-control">
                                <?php
...
@section('body_last')
    <script src="{{ url('js/employees.js') }}" type="text/javascript"></script>
@endsection
