                                                ...
                                                <div class="col-12 view-wrap">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-auto  text-center ">
                                                            <span class="manageEmp icon-edit kt-font-lg kt-font-success kt-font-bold text-uppercase">Manage Employees</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <label for="_ip_job_num_employees" class="col-12 col-form-label kt-font-bold edit-field">Number of Employees assigned</label>
                                                <div class="col-12 edit-field">
                                                    <input id="_ip_job_num_employees" class="form-control" name="_ip_job_num_employees" type="number" value="12">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    <select class="form-control kt-select2" id="_ip_job_cost_codes" name="_ip_job_cost_codes[]" multiple="multiple">
                                                                        @foreach($costcodes as $id => $costcode)
                                                                            <option value="{{$costcode->id}}">{{$costcode->id}} - {{$costcode->name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-12 view-wrap-multiple">
                                                    <div class="paygroups-show kt-font-bold">Assigned Paygroups: 
                                                        ...
                                                        @foreach($project->paygroups as $projectPaygroup)
                                                        ...
                                                        <div class="col">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col">
                                                                    ...
                                                                    @foreach($paygroups as $id => $paygroup)
                                                                        <option value="{{$paygroup->id}}" {{ ($project->paygroups->contains($id)) ? 'selected' : '' }}>{{$paygroup->name}}</option>
                                                                    @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
