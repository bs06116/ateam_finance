                                ...
                                <div class="col-xl-12">
                                                ...
                                                <div class="align-items-center d-flex user-box__body">
                                                    ...
                                                    <div class="user-box__desc">
                                                        ...
                                                        <div class="user-box__content">
                                                            <p class="m-0">Exmaple@gmail.com</p> 
                                                            <p class="m-0">410-679-0441</p>   
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="kt-section">
                                        <div class="kt-section__body"> 
                                            ...
                                            <p>Total 12 projects are assigned to john smith</p>
                                                            ...
                                                            <div class="kt-portlet__body">
                                                                <div class="kt-callout__body">
                                                                    <div class="kt-callout__content">
                                                                        <h3 class="kt-callout__title">Project Name Here</h3>
                                                                        <p class="kt-callout__desc">
                                                                            Windows 10 automatically installs updates to make for sure
                                                                        </p>
                                                                    </div>
                                                                    <div class="kt-callout__action">
                                                                        <a href="#" class="btn btn-bold btn-primary btn-upper">Edit Project</a>
                                                                    </div>
                                                                </div>
                                                                <div class="kt-space-30"></div>
                                                                <div class="row">
                                                                    <div class="col-auto border-right">
                                                                        <div class="kt-font-bold">Project Manager: <span class="kt-font-primary">Kristen Aura</span></div>
                                                                    </div>
                                                                    <div class="col-auto border-right">
                                                                        <div class="kt-font-bold">Project Foreman: <span class="kt-font-primary">Slea Doe</span></div>
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="kt-font-bold">Number of Employees assigned: <span class="kt-font-primary">12</span></div>
                                                                    </div>
                                                                </div>
                                                                <div class="kt-separator kt-separator--space-md"></div>
                                                                <div class="d-flex">
                                                                    <div class="pr-4">Initial date: 02/10/2020</div>
                                                                    <div class="pl-4 border-left">Initial date: 02/10/2020</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> 
